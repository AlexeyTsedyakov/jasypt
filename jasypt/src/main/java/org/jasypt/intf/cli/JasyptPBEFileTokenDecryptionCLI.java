...
public class JasyptPBEFileTokenDecryptionCLI {
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            if (args[0] == null || args[0].contains("=")) {
                applicationName = JasyptPBEFileTokenDecryptionCLI.class.getName();
                arguments = args;
            } else {
            ...
            while (matcher.find()) {
                ...
                String replacement = "DEC(" + decrypt(encrypted, argumentValues) + ")";
    ...
    private static String decrypt(String input, Properties argumentValues) {
     ...
     */
    private JasyptPBEFileTokenDecryptionCLI() {
        super();
    }
}
